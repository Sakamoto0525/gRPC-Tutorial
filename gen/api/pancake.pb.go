...
type Report_BakeCount struct {
	...
	Menu  Pancake_Menu `protobuf:"varint,1,opt,name=menu,proto3,enum=pancake.baker.Pancake_Menu" json:"menu,omitempty"`
	Const int32        `protobuf:"varint,2,opt,name=const,proto3" json:"const,omitempty"`
}
...
func (x *Report_BakeCount) GetConst() int32 {
	if x != nil {
		return x.Const
	}
	return 0
...
var file_pancake_proto_rawDesc = []byte{
	...
	0x14, 0x0a, 0x05, 0x63, 0x6f, 0x6e, 0x73, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05,
	0x63, 0x6f, 0x6e, 0x73, 0x74, 0x22, 0x3e, 0x0a, 0x0b, 0x42, 0x61, 0x6b, 0x65, 0x52, 0x65, 0x71,
